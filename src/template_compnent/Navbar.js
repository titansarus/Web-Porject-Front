...
class Navbar extends Component {
    ...
    search(){
        console.log("click")
        return (<Redirect to={"/search/"+document.getElementById("search").value}/>)
    }
        ...
        return (
            <nav className="navbar navbar-expand-lg navbar-light bg-light">
                ...
                <div className="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <form className="form-inline my-2 my-lg-0" action="http://127.0.0.1:3000/search/">
                        <input className="form-control mr-sm-2" type="search" placeholder="Search" aria-label="Search" name="search"/>
                        <button className="btn btn-outline-success my-2 my-sm-0"  type="submit" id="search">Search</button>
                    </form>
