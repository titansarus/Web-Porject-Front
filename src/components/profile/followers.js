        ...
        fetch(url, requestOptions)
            ...
            .then(function (result) {
                ...
                for (const channel of obj.data.follower) {
                    document.getElementById("row").innerHTML += '<a href="/channel/'+channel.chanel.identifier+'"><div class="card-body"> <h6 class="card-title">'+channel.chanel.identifier+'</h6></div></a>'
                }
